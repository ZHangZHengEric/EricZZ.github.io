...
![mcp 架构](https://developer.qcloudimg.com/http-save/yehe-100000/bcc3c042e47bd045374e4dd222276c70.png)
...
![mcp使用说明](https://developer.qcloudimg.com/http-save/yehe-100000/759b4bf7d4921031eed55ac293a82e87.gif)
...
```
\# 自动获取工具列表
tools = mcp\_client.get\_tools()
print(tools)
\# 输出：\["get\_weather", "query\_retention\_rate"]
```
